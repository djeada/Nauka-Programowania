...
class Ksztalt {
    ...
    pole() {
        throw new Error(`Nie zaimplementowano metody pole() w klasie ${this.constructor.name}`);
    }

    obwod() {
        throw new Error(`Nie zaimplementowano metody obwod() w klasie ${this.constructor.name}`);
    }
