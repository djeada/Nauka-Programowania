...
int main() {
  ...
  std::cin >> a;
  std::cout << "objetosc kuli o promieniu " << a << " jest rowna " << 4 / 3 *3.14 * a * a * a << std::endl;

  std::cout << "podaj promien podstawy i wysokosc stozka:" << std::endl;
  std::cin >> a;
  std::cin >> b;
  std::cout << "objetosc stozka o promieniu podstawy " << a << " i wysokosci " << b
            << " jest rowna " << 1/3*3.14 * a *a * b  << std::endl;

  std::cout << "podaj dlugosc, szerokosc i wysokosc graniastoslupa:" << std::endl;
  std::cin >> a;
  std::cin >> b;
  float c;
  std::cin >> c;
  std::cout << "objetosc graniastoslupa o dlugosci " << a << " szerokosci " << b << " i wysokosci " << c
            << " jest rowna " << a * b * c << std::endl;
