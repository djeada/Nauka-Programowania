...
if __name__ == "__main__":
    ...
    print(f'Lista po pomnozeniu kazdego elementu przez indeks: {pomnoz_przez_indeks(lista)}')
    print(f'Lista po zastapieniu kazdego elementu wartoscia pierwszego elementu: {zastap_pierwszym(lista)}')
