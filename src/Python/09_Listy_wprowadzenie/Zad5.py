...
def test_suma_wszystkich_na_pierwszych_indeksach():
    ...
    assert suma_wszystkich_na_pierwszych_indeksach([1, 2, 3, 4, 5, 6]) == [1, 2, 21, 21, 5, 21]
    assert suma_wszystkich_na_pierwszych_indeksach([0, 0, 10, -5, -2]) == [0, 0, 3, 3, -2]
...
def test_zamien_na_iloczyn_wszystkich_poza_soba():
    ...
    assert zamien_na_iloczyn_wszystkich_poza_soba([3, 5, -7, 4, 9, -11, 2]) == [27720, 16632, -11880, 20790, 9240, -7560, 41580]
