...
if __name__ == "__main__":
    ...
    print("Liczby naturalne większe od mniejszej pobranej liczby i jednocześnie mniejsze od większej pobranej liczby:")
    ...
    print("\n")
    print("Liczby naturalne podzielne przez 3 większe od mniejszej pobranej liczby i jednocześnie mniejsze od większej pobranej liczby:")
