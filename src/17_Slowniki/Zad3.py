...
def test_dodaj_ksiazke_do_czytelnika():
    assert dodaj_ksiazke_do_czytelnika({'Jan': {'Ksiazka1', 'Ksiazka2'}}, 'Jan', 'Ksiazka3') == {'Jan': {'Ksiazka1', 'Ksiazka2', 'Ksiazka3'}}
    assert dodaj_ksiazke_do_czytelnika({'Jan': {'Ksiazka1', 'Ksiazka2'}}, 'Adam', 'Ksiazka3') == {'Jan': {'Ksiazka1', 'Ksiazka2'}, 'Adam': {'Ksiazka3'}}
    assert dodaj_ksiazke_do_czytelnika({'Jan': {'Ksiazka1', 'Ksiazka2'}}, 'Jan', 'Ksiazka1') == {'Jan': {'Ksiazka1', 'Ksiazka2'}}

def test_zwroc_ksiazke_czytelnika():
    assert zwroc_ksiazke_czytelnika({'Jan': {'Ksiazka1', 'Ksiazka2'}}, 'Jan', 'Ksiazka1') == {'Jan': {'Ksiazka2'}}
