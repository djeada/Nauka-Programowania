...
def liczba_wierszy(tresc_pliku):
    """
    Funkcja licząca liczbę wierszy w pliku
    """
...
def liczba_slow(tresc_pliku):
    """
    Funkcja licząca liczbę słów w pliku
    """
    licznik = 0
...
def test_statystyki():
    ...
    plik.write_text("\n".join(['Hej ', 'This is an example of a simple ASCII text file stored on a Web server. Note that it has a file', 'extension of \".txt\".\n','Although such files may contains some basic layout formatting, such as paragraphs, there is no', 'support for the text to have attributes, such as bolding.\n', 'Text files can contain Hypertext Mark-up codes but these will not be interpreted by the ', 'browser. For example, if the following characters <strong>hello</strong> were typed into an','"html" file then the word "hello" would be shown in bold.']))
    ...
    assert(czestosc_slow(tresc_pliku) ==  {"bold": 1, "in": 1, "shown": 1,       "word": 1, "then": 1,        "html": 1, "simple": 1,      "basic": 1, "contains": 1,    "layout": 1, "were": 1,        "may": 1, "such": 3,        "file": 3, "extension": 1, "files": 2,       "it": 1, "hypertext": 1,   "hello": 1, "note": 1, "web": 1,         "ascii": 1,  "is": 2,          "an": 2, "example": 2,     "hej": 1, "following": 1,   "this": 1, "of": 2,  "txt": 1, "although": 1, "text": 3,        "stored": 1, "that": 1,        "by": 1, "on": 1,          "formatting": 1, "support": 1,   "browser": 1, "typed": 1,       "a": 3, "server": 1,      "would": 1, "contain": 1,     "as": 2, "markup": 1,      "characters": 1, "there": 1,       "for": 2, "the": 4,         "to": 1, "have": 1,        "these": 1, "will": 1,        "paragraphs": 1, "attributes": 1,  "bolding": 1, "can": 1,         "has": 1, "codes": 1,       "if": 1, "some": 1,  "no":1,      "but": 1, "not": 1,         "be": 2, "interpreted": 1, "stronghellostrong": 1, "into": 1})
