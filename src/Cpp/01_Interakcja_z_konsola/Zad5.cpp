...
punkcie. b) Pobierz wspolczynniki a, b oraz punkt x. Wyznacz wartosc funkcji y =
ax + b w zadanym punkcie. c) Otrzymujesz wspolrzedna x. Wyznacz wartosc funkcji
y = x3 + 22 - 20 w zadanym punkcie. d) Pobierz wspolczynniki a, b, c, d, m, n
