...
unordered_map<string, int> budujSlownik(const string& tekst) {
	unordered_map<string, int> slownik;

	vector<string> slowa = rozdzielSlowa(tekst);
...
void test1() {
	string slowo = "Here,,,, a tricksy corpus will exist; a very strange, a sometimes cryptic corpus will dumbfound you maybe, "
	...
	unordered_map<string, int> wynik {{"here", 1}, {"a", 12}, {"tricksy", 4}, {"corpus", 5}, {"will", 6}, {"exist", 1}, {"very", 2},
...
void test2() {
	string slowo = "The most intelligent people disguise the fact that they are intelligent. Wise men do not wear name tags., "
		"The more people talk about their own skills, the more desperate they are--their work should speak for itself.";


	unordered_map<string, int> wynik {{"itself", 1}, {"should", 1}, {"desperate", 1}, {"aretheir", 1}, {"own", 1}, {"their", 1}, 
