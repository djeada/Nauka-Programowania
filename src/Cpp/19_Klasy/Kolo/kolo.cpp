...
void Kolo::setPromien(double r) { promien = r; }

double Kolo::getPromien() { return promien; }

double Kolo::pole() { return std::numbers::pi * pow(promien, 2); }

double Kolo::obwod() { return 2 * std::numbers::pi * promien; }

double Kolo::srednica() { return 2 * promien; }
