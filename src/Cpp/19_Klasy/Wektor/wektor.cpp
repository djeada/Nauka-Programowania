...
Wektor::Wektor(double _x, double _y, double _z) : x(_x), y(_y), z(_z) {}

void Wektor::setX(double _x) { x = _x; }

void Wektor::setY(double _y) { y = _y; }

void Wektor::setZ(double _z) { z = _z; }

double Wektor::getX() { return x; }

double Wektor::getY() { return y; }

double Wektor::getZ() { return z; }
