...
public class Main
{
	...
	public static void test1()
	{
		...
		assert dodaj(new ArrayList<ArrayList<Integer>>(macierzA), new ArrayList<ArrayList<Integer>>(macierzB)) == wynik;
	}
	...
	public static void test2()
	{
		...
		assert odejmij(new ArrayList<ArrayList<Integer>>(macierzA), new ArrayList<ArrayList<Integer>>(macierzB)) == wynik;
	}
