...
public class Main
{
	...
	{
		if (slowoWej.length() == 0 && palindrom(slowoWyj) && find(wynik.iterator(), wynik.end(), slowoWyj) == wynik.end())
		{
			wynik.add(slowoWyj);
			return;
		}
	...
	public static void test1()
	{
		...
		assert wektoryRowne(permutacje(slowo), new ArrayList<String>(wynik));
	}
