...
public class Main {
  ...
  public static void test1() {
    ArrayList<Integer> lista = new ArrayList<Integer>(Arrays.asList(0, 1, 3, 0, 8, 12, 0, 4, 0, 7, 0));
    ArrayList<Integer> wynik = new ArrayList<Integer>(Arrays.asList(1, 3, 8, 12, 4, 7, 0, 0, 0, 0, 0));
