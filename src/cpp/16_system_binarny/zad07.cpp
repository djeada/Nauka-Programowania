...
Wczytaj liczbę naturalną `n`. Zamień miejscami każdą parę sąsiadujących bitów w
jej zapisie binarnym:
...
* Jeśli liczba ma nieparzystą liczbę bitów, najwyższy (samotny) bit pozostaje
bez zmian.
