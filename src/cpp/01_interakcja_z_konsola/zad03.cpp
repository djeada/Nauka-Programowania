...
2. **Trójkąt liczbowy** z 3 linii: w linii `i` wypisz `i` razy cyfrę `i` (dla
i=1..3)
...
* Nie dodawaj dodatkowych pustych linii na początku; jedna na końcu jest zwykle
akceptowalna, ale trzymaj się przykładu.
