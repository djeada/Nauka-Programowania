...
Wczytaj tekst. Policz częstość występowania słów (tylko litery), ignorując
wielkość liter. Wypisz słownik: słowo (małe litery) → liczba wystąpień.
...
std::unordered_map<std::string, int> budujSlownik(const std::string &tekst) {
  ...
  for (const auto &slowo : slowa) slownik[slowo]++;
...
void test1() {
  ...
  std::unordered_map<std::string, int> wynik{
      {"here", 1},       {"a", 12},       {"tricksy", 4},   {"corpus", 5},
      {"will", 6},       {"exist", 1},    {"very", 2},      {"strange", 1},
      {"sometimes", 1},  {"cryptic", 1},  {"dumbfound", 1}, {"you", 2},
      {"maybe", 1},      {"perhaps", 1},  {"bit", 1},       {"in", 1},
      {"particular", 1}, {"since", 1},    {"my", 1},        {"not", 1},
      {"match", 1},      {"the", 2},      {"pattern", 1},   {"expect", 1},
      {"from", 2},       {"it", 2},       {"nor", 1},       {"look", 1},
      {"like", 1},       {"fish", 1},     {"boat", 1},      {"sunflower", 1},
      {"or", 3},         {"handsome", 1}, {"kitten", 1},    {"surprise", 1},
      {"user", 1},       {"named", 1},    {"ami", 1},       {"tavory", 1},
      {"this", 1},       {"be", 1},       {"fun", 1},       {"to", 1},
      {"follow", 1},     {"year", 1},     {"month", 1},     {"minute", 1},
      {"now", 1}};
...
void test2() {
  ...
  std::unordered_map<std::string, int> wynik{
      {"itself", 1},   {"should", 1},      {"desperate", 1}, {"aretheir", 1},
      {"own", 1},      {"their", 1},       {"tags", 1},      {"name", 1},
      {"wear", 1},     {"the", 4},         {"work", 1},      {"most", 1},
      {"they", 2},     {"intelligent", 2}, {"for", 1},       {"speak", 1},
      {"skills", 1},   {"not", 1},         {"people", 2},    {"fact", 1},
      {"about", 1},    {"do", 1},          {"talk", 1},      {"more", 2},
      {"disguise", 1}, {"that", 1},        {"are", 1},       {"wise", 1},
      {"men", 1}};
