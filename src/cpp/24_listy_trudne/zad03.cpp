...
Otrzymujesz listę liczb całkowitych. Znajdź **najmniejszy możliwy iloczyn trzech
liczb** wybranych z tej listy.

Jeśli lista zawiera mniej niż 3 liczby — wypisz iloczyn wszystkich elementów
listy.
