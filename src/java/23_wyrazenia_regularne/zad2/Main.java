...
public class Main {
  ...
  public static void test1() {
    List<String> poprawneHasla = Arrays.asList(
    ...
    for (String haslo : poprawneHasla)
      assert(poprawneHaslo(haslo));
  }

  public static void test2() {
    List<String> niepoprawneHasla = Arrays.asList(
        "123456",   "proste_haslo123", "haslo", "pizza&*!",
        "!!!!!!!!", "_____123_____",   "...",   "abcd32",
        "AB***DB",  "22tajnE",         "Ab6*");

    for (String haslo : niepoprawneHasla)
      assert(!poprawneHasla(haslo));
  }
