...
public class Main {
  ...
  public static void skopiujPlik(final String sciezka, final String sciezkaDocelowa) {
    ...
    var cel =
        (new File(sciezkaDocelowa + System.getProperty("file.separator") + nazwaPliku(sciezka)))
            .toPath();
    try {
  ...
  public static void main(String[] args) {
    ...
    final String sciezkaDocelowa =
        System.getProperty("user.dir") + System.getProperty("file.separator") + "folder2";
