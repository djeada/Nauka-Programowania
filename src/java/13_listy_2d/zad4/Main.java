...
public class Main {
  ...
  public static ArrayList<ArrayList<Integer>> dodaj(
    ...
    if (!wymiaryRowne(
        new ArrayList<ArrayList<Integer>>(macierzA), new ArrayList<ArrayList<Integer>>(macierzB))) {
  ...
  public static ArrayList<ArrayList<Integer>> odejmij(
      ArrayList<ArrayList<Integer>> macierzA, ArrayList<ArrayList<Integer>> macierzB) {
  ...
  public static void test1() {
    ArrayList<ArrayList<Integer>> macierzA =
        new ArrayList<ArrayList<Integer>>(
            Arrays.asList(
                new ArrayList<Integer>(Arrays.asList(1, 2)),
                new ArrayList<Integer>(Arrays.asList(-2, 0))));
    ArrayList<ArrayList<Integer>> macierzB =
        new ArrayList<ArrayList<Integer>>(
            Arrays.asList(
                new ArrayList<Integer>(Arrays.asList(5, -3)),
