...
public class Main {
  ...
  public static void test1() {
    String slowo =
        "Here,,,, a tricksy corpus will exist; a very strange, a sometimes cryptic corpus will"
            + " dumbfound you maybe, perhaps a bit; in particular since my tricksy corpus will not"
            + " match the pattern you EXPECT from it; nor will it look like a fish, a boat, a"
            + " sunflower, or a very handsome kitten. The tricksy corpus will surprise a user named"
            + " Ami Tavory; this tricksy corpus will be fun to follow a year or a month or a minute"
            + " from now.";

    HashMap<String, Integer> wynik =
  ...
  public static void test2() {
    String slowo =
        "The most intelligent people disguise the fact that they are intelligent. Wise men do not"
            + " wear name tags., The more people talk about their own skills, the more desperate"
            + " they are--their work should speak for itself.";
