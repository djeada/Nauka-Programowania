...
class Czlowiek:
    ...
    def __eq__(self, other):
        return self.imie == other.imie and self.nazwisko == other.nazwisko and self.miejsce_urodzenia == other.miejsce_urodzenia and self.zawod == other.zawod
...
class Student(Czlowiek):
    def __init__(self, imie, nazwisko, miejsce_urodzenia, numer_albumu, kierunek_studiow):
    ...
    def __eq__(self, other):
        return super().__eq__(other) and self.numer_albumu == other.numer_albumu and self.kierunek_studiow == other.kierunek_studiow
    
    def __ne__(self, other):
        return not self.__eq__(other)

class StudentFizyki(Student):
    def __init__(self, imie, nazwisko, miejsce_urodzenia, numer_albumu, srednia_z_lab, srednia_z_wykl):
    ...
    def __eq__(self, other):
        return super().__eq__(other) and self.srednia_z_lab == other.srednia_z_lab and self.srednia_z_wykl == other.srednia_z_wykl
